...
import { decimalToHex } from "@/converters/decimalToHex";
import { hexToDecimal } from "@/converters/hexToDecimal";
...
export default function DecimalToHex() {
  ...
  const handleConvert = () => {
    ...
    const conversion = isReversed ? hexToDecimal(input) : decimalToHex(input);
      ...
      <div className="flex justify-center items-center p-4">
        <Card className="w-full max-w-lg bg-gray-100 dark:bg-gray-900 shadow-xl p-6 min-h-[400px] flex flex-col justify-between">
          <h1 className="text-2xl font-bold text-center text-gray-900 dark:text-white">
            {isReversed ? "Hexadecimal a Decimal" : "Decimal a Hexadecimal"}
          </h1>
          ...
          <div className="flex flex-col gap-4 flex-grow">
            ...
            <Input
              ...
              placeholder={isReversed ? "Ingrese Hexadecimal" : "Ingrese Decimal"}
              className="w-full"
              size="lg"
            />
            <Button 
            ...
            <ConverterToggle 
              ...
              option1="Cambiar a Hexadecimal → Decimal" 
              option2="Cambiar a Decimal → Hexadecimal"
            />
          </div>
        </Card>
      </div>
